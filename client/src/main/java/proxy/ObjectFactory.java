...
public class ObjectFactory {
    ...
    private static final QName _Conversion_QNAME = new QName("http://imadev.io/", "conversion");
    private static final QName _ConversionResponse_QNAME = new QName("http://imadev.io/", "conversionResponse");
    private static final QName _GetCompte_QNAME = new QName("http://imadev.io/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://imadev.io/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://imadev.io/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://imadev.io/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://imadev.io/", name = "listComptesResponse")
