 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://imadev.io/", wsdlLocation = "http://localhost:8081/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://imadev.io/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://imadev.io/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://imadev.io/", "BanqueServicePort"), BanqueService.class, features);
    }
